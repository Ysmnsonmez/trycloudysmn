...
public class Driver {
    //Creating a private constructor, so we are closing to the object of this class
    //from outside of any classes
    private Driver() {
    }

    //Making our "driver" instance private,so that is not reachable from the
    //outside of any class.We make it static, because we want to run before anything else,
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {   //if driver/browser was never opened
            ...
            //Depending on the browserType our switch statement will determine to open
